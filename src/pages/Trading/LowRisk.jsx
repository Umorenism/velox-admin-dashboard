...
const LowRisk = () => {
  const lowRiskTraders = tradersData.filter((t) => t.risk === "Low");
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold mb-6 text-neutral-800 dark:text-neutral-100 flex items-center gap-2">
        <ShieldCheck className="text-green-500" /> Low Risk Traders
      </h1>

      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {lowRiskTraders.map((t) => (
          <motion.div
            key={t.id}
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-500">{t.risk} Risk</p>
              </div>
            </div>
