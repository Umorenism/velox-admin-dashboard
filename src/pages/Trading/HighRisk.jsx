...
const HighRisk = () => {
  const highRiskTraders = tradersData.filter((t) => t.risk === "High");
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold mb-6 text-neutral-800 dark:text-neutral-100 flex items-center gap-2">
        <Flame className="text-red-500" /> High Risk Traders
      </h1>

      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {highRiskTraders.map((t) => (
          <motion.div
            key={t.id}
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-500">{t.risk} Risk</p>
              </div>
            </div>
