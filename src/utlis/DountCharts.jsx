...
// // // const COLORS = ["#f6efefff", "#FBEFE3", "#EE933C", "#F3C89F", "#FAE3CD"];


// // // const CustomTooltip = ({ active, payload }) => {
// // //   if (active && payload && payload.length) {
// // //     return (
// // //       <div className="bg-neutral-900 text-white text-xs px-2 py-1 rounded-md shadow-md">
// // //         {`${payload[0].value}%`}
// // //       </div>
// // //     );
// // //   }
...
// // const COLORS = ["#FFFFFF", "#FBEFE3", "#EE933C", "#F3C89F", "#FAE3CD"];
...
// // ✅ Custom label component with black tooltip box + triangle pointer
...
//   const radius = outerRadius + 20; // how far the label sits from the circle
...
//     >
//       <div className="relative bg-black text-white text-[10px] px-2 py-1 rounded-md shadow-md text-center">
//         {value}%
//         <div className="absolute left-1/2 -bottom-[5px] -translate-x-1/2 w-0 h-0 border-l-[4px] border-l-transparent border-r-[4px] border-r-transparent border-t-[5px] border-t-black" />
//       </div>
//     </foreignObject>
//   );
// };
