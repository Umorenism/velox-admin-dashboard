...
const RoleDetails = () => {
  ...
  return (
    <motion.div
      className="max-w-5xl mx-auto p-6 bg-white rounded-xl shadow-sm border border-gray-200"
    ...
    >
      {/* Role Header */}
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-1">Role 1</h2>
      ...
      {/* Members Badge */}
      <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-700 text-sm px-3 py-1.5 rounded-md border border-gray-200 mb-6">
        <FiTrash2 className="text-gray-500" />
        You currently have <span className="font-medium">6 members</span> with this role
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <h3 className="text-teal-600 font-semibold mb-4">
